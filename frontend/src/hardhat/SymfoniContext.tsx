...
import { RibbitDaycare } from "./typechain/RibbitDaycare";
import { RibbitDaycare__factory } from "./typechain/factories/RibbitDaycare__factory";
...
export const RibbitDaycareContext = React.createContext<SymfoniRibbitDaycare>(emptyContract);
...
export interface SymfoniRibbitDaycare {
    instance?: RibbitDaycare;
    factory?: RibbitDaycare__factory;
}
...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const [RibbitDaycare, setRibbitDaycare] = useState<SymfoniRibbitDaycare>(emptyContract);
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        const doAsync = async () => {
            ...
            const finishWithContracts = (text: string) => {
                setRibbitDaycare(getRibbitDaycare(_provider, _signer))
                finish(text)
            }
            ...
            <ProviderContext.Provider value={[provider, setProvider]}>
                <SignerContext.Provider value={[signer, setSigner]}>
                    <CurrentAddressContext.Provider value={[currentAddress, setCurrentAddress]}>
                        <RibbitDaycareContext.Provider value={RibbitDaycare}>
                            {showLoading && loading ?
